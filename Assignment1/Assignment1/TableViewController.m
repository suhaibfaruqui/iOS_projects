...
- (void)viewDidLoad {
    ...
    recipe15.prepTime = @"Time: 4 hours";
    ...
    items = [NSArray arrayWithObjects:recipe1, recipe2, recipe3, recipe4, recipe5, recipe6, recipe7, recipe8, recipe9, recipe10, recipe11, recipe12, recipe13, recipe14, recipe15, recipe16, nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.imageView.image = [UIImage imageNamed:[[items objectAtIndex:indexPath.row] imageFile]];
    return cell;
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"showRecipeDetail"]) {
        NSIndexPath *indexPath1 = [self.tableView1 indexPathForSelectedRow];
        DetailTableViewController *destViewController1 = segue.destinationViewController;
        destViewController1.recipe = [items objectAtIndex:indexPath1.row];
    }
}
