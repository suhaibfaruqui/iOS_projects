...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIImage *img = [[UIImage alloc] initWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:[[[returnedDict objectAtIndex:indexPath.row] objectForKey:@"user"] objectForKey:@"profile_image_url"]]]];
